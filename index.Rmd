...
Additionally, oil, the coefficient is -6.428115 which means that for every 1 unit of oil, there is a decrease of -6.428116 units on democracy levels. Moreover, if a country were to go from being a country with oil to no oil, then it would impact the polity score with an average of -6.428.
